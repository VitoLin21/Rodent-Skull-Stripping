...
def export_prediction_from_sigmoid(predicted_array_or_file: Union[np.ndarray, str], properties_dict: dict,
    ...
    predicted_array_or_file = configuration_manager.resampling_fn(predicted_array_or_file,
                                                                  properties_dict[
    ...
    if save_probabilities:
        ...
        predicted_array_or_file = torch.sigmoid(torch.from_numpy(predicted_array_or_file)).numpy()
    ...
    rw.write_seg(segmentation_reverted_cropping,
                 output_file_truncated + '_0000' + dataset_json_dict_or_file['file_ending'],
                 properties_dict)
